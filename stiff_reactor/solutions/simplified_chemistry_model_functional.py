...
sol = {alt : solve_ivp(lambda t, c : reactor_model(t,c,stoich_mat,Te[alt]), tspan[alt], c0[alt], t_eval = t_eval[alt], method = 'LSODA') for alt in alts}
