...
function main()
    ...
    @showprogress "Timestepping ..." for iter in 1:N_TIME_STEPS
        ...
        # velocity at next time step is the velocity a time step in the past along the streamline (with appropriate adjustment of the velocity due to forcing)
        ...
        # apparently the mean shall remain 0 (conservation of momentum)
